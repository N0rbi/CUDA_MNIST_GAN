...
class GAN(object):
    def __init__(self, width = 28, height= 28, channels = 1):
        ...
        self.OPTIMIZER = Adam(lr=0.000009, decay=8e-9)
    ...
    def train(self, X_train, epochs=20001, batch = 32, save_interval = 200):
    ...
    def plot_images(self, save2file=False,  samples=16, step=0):
        filename = "./images_no_batchnorm/mnist_%d.png" % step
